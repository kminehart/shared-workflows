...
## [0.4.0](https://github.com/kminehart/shared-workflows/compare/docker-build-push-image/v0.3.4...docker-build-push-image/v0.4.0) (2026-06-21)


### 🎉 Features

* **docker-build-push-image:** add builder input ([#1605](https://github.com/kminehart/shared-workflows/issues/1605)) ([e39baa6](https://github.com/kminehart/shared-workflows/commit/e39baa6584886aef49fe533215defc5627ffbd3f))
...
* **docker-build-push-image:** pass builder name to docker/build-push-action ([#1602](https://github.com/kminehart/shared-workflows/issues/1602)) ([59bb68c](https://github.com/kminehart/shared-workflows/commit/59bb68c6a0a1bc5701261915eaa04199916be716))
* remove `s` from metadatajson ([#2086](https://github.com/kminehart/shared-workflows/issues/2086)) ([8a16b96](https://github.com/kminehart/shared-workflows/commit/8a16b96ee18c77596b132a2b8fac70dc6e30fd6b))
...
* **docker-build-push-image:** clarify push input defaults ([#1719](https://github.com/kminehart/shared-workflows/issues/1719)) ([256dfbb](https://github.com/kminehart/shared-workflows/commit/256dfbbabfebc3e21d15113e9f5e876ba2fe7b48))
...
* **deps:** update docker/build-push-action action to v6.19.0 ([#1717](https://github.com/kminehart/shared-workflows/issues/1717)) ([37c176c](https://github.com/kminehart/shared-workflows/commit/37c176c8a62d075692cbafeacbc4ea31613a33c5))
* **deps:** update docker/build-push-action action to v6.19.2 ([#1721](https://github.com/kminehart/shared-workflows/issues/1721)) ([bf35378](https://github.com/kminehart/shared-workflows/commit/bf35378348bf907badcc18ddf782201261c62d8c))
* **deps:** update docker/build-push-action action to v7 ([#1785](https://github.com/kminehart/shared-workflows/issues/1785)) ([490b672](https://github.com/kminehart/shared-workflows/commit/490b6727050ad2740e5a8f86ac0e6c9e653fc15b))
* **deps:** update docker/build-push-action action to v7.1.0 ([#1864](https://github.com/kminehart/shared-workflows/issues/1864)) ([32404b4](https://github.com/kminehart/shared-workflows/commit/32404b4f4a2a8ec646d6ee76ed3df0ab8f84bdfb))
* **deps:** update docker/build-push-action action to v7.2.0 ([#2018](https://github.com/kminehart/shared-workflows/issues/2018)) ([647de49](https://github.com/kminehart/shared-workflows/commit/647de495fb2403f2261b034a1b4610904cb38bf2))
* **deps:** update docker/metadata-action action to v5.10.0 ([#1582](https://github.com/kminehart/shared-workflows/issues/1582)) ([d80ddba](https://github.com/kminehart/shared-workflows/commit/d80ddba3b588ad911410ce91c599bbbe513196b0))
* **deps:** update docker/metadata-action action to v6 ([#1787](https://github.com/kminehart/shared-workflows/issues/1787)) ([de48747](https://github.com/kminehart/shared-workflows/commit/de48747bf25be41fcb04d5d6ff05cc5eed0775fe))
* **deps:** update docker/metadata-action action to v6.1.0 ([#2021](https://github.com/kminehart/shared-workflows/issues/2021)) ([ac9ad90](https://github.com/kminehart/shared-workflows/commit/ac9ad908f81ccdceca9cb9f640c08a97e3073ba9))
* **deps:** update docker/setup-buildx-action action to v3.12.0 ([#1633](https://github.com/kminehart/shared-workflows/issues/1633)) ([9c7001f](https://github.com/kminehart/shared-workflows/commit/9c7001fb8ab6048113c07b6454aea78589e0e6b9))
* **deps:** update docker/setup-buildx-action action to v4 ([#1791](https://github.com/kminehart/shared-workflows/issues/1791)) ([2376476](https://github.com/kminehart/shared-workflows/commit/2376476a8678d5422711041823033659e4872548))
* **deps:** update docker/setup-buildx-action action to v4.1.0 ([#2022](https://github.com/kminehart/shared-workflows/issues/2022)) ([e942a3a](https://github.com/kminehart/shared-workflows/commit/e942a3a5775e102da33db1bcb193cfddb3a47a26))
* **deps:** update docker/setup-qemu-action action to v4 ([#1792](https://github.com/kminehart/shared-workflows/issues/1792)) ([a13ffd7](https://github.com/kminehart/shared-workflows/commit/a13ffd766a74b4e4861aae33dc7fcfdecb5aad5a))
* **deps:** update docker/setup-qemu-action action to v4.1.0 ([#2023](https://github.com/kminehart/shared-workflows/issues/2023)) ([4f49606](https://github.com/kminehart/shared-workflows/commit/4f49606ee0350fdbbcbe95cd9a64486f89da32ae))
* **deps:** update grafana/shared-workflows/dockerhub-login action to v2.0.0 ([#2096](https://github.com/kminehart/shared-workflows/issues/2096)) ([b9bd9af](https://github.com/kminehart/shared-workflows/commit/b9bd9af9d088e4a7abca2fdc75b0ca10f7aae9de))
* **deps:** update grafana/shared-workflows/login-to-gar action to v1.0.3 ([#2091](https://github.com/kminehart/shared-workflows/issues/2091)) ([80f6a4e](https://github.com/kminehart/shared-workflows/commit/80f6a4efd0f3f38df47e42816a261e95fad0c4a8))
* **main:** release docker-build-push-image 0.3.0 ([#1542](https://github.com/kminehart/shared-workflows/issues/1542)) ([ef27c62](https://github.com/kminehart/shared-workflows/commit/ef27c620a88acc9f3007f30be5e9407324e8975b))
* **main:** release docker-build-push-image 0.3.1 ([#1641](https://github.com/kminehart/shared-workflows/issues/1641)) ([438c8d6](https://github.com/kminehart/shared-workflows/commit/438c8d6321147607b3f6f0e922508e78e746af9b))
* **main:** release docker-build-push-image 0.3.2 ([#1790](https://github.com/kminehart/shared-workflows/issues/1790)) ([21ae57f](https://github.com/kminehart/shared-workflows/commit/21ae57f82e5256e5a418406388926d4ba24bccf2))
* **main:** release docker-build-push-image 0.3.3 ([#1873](https://github.com/kminehart/shared-workflows/issues/1873)) ([34f2788](https://github.com/kminehart/shared-workflows/commit/34f27887c37cafe70d34af57dfc86b468a31b8c4))
* **main:** release docker-build-push-image 0.3.4 ([#2054](https://github.com/kminehart/shared-workflows/issues/2054)) ([c66d74d](https://github.com/kminehart/shared-workflows/commit/c66d74df41cf4ed28a90da1d91c263f9d1609a21))
* **multiple:** deprecate old docker actions and add migration guide ([#1606](https://github.com/kminehart/shared-workflows/issues/1606)) ([b6c252d](https://github.com/kminehart/shared-workflows/commit/b6c252dc86cb65eaf2d8344d6d51ca07436214a2))
